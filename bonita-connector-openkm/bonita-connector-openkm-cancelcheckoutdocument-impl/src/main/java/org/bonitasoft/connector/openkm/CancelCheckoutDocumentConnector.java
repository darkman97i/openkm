...
public class CancelCheckoutDocumentConnector extends OpenKMConnector {
	...
	protected OpenKMResponse executeAction(OKMWebservices ws) {
		if (LOGGER.isLoggable(Level.INFO)) {
            LOGGER.info("Executing CancelCheckoutConnector with params: documentName:"+docId);
        }
		
		OpenKMResponse response = new OpenKMResponse();
	
		try {
			ws.cancelCheckout(docId);		
