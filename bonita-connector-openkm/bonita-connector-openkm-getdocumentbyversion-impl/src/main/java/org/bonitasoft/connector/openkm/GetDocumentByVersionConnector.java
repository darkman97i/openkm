...
public class GetDocumentByVersionConnector extends OpenKMConnector {
	...
	protected OpenKMResponse executeAction(OKMWebservices ws) {
		...
		try {
			...
			in = ws.getContentByVersion(docId, versionId);
	...
	protected final String getVersionId() {
		return (String) getInputParameter(VERSION_ID);
	}
