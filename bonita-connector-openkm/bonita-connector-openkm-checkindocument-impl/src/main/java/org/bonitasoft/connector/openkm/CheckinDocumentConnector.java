...
public class CheckinDocumentConnector extends OpenKMConnector {
	...
	public void validateInputParameters() throws ConnectorValidationException {
		...
		try {
			...
			throw new ConnectorValidationException("docId type is invalid");
		}
		try {
			comment = getComment();
		} catch (ClassCastException cce) {
			throw new ConnectorValidationException("comment type is invalid");
		}
	...
	protected OpenKMResponse executeAction(OKMWebservices ws) {
		if (LOGGER.isLoggable(Level.INFO)) {
            LOGGER.info("Executing CreateDocumentSimpleConnector with params: fileObject:"+fileObject+", docId:"+docId+", comment:"+comment);
        }
	...
	protected final String getComment() {
		return (String) getInputParameter(COMMENT);
	}
}