...
public class DeleteDocumentConnector extends OpenKMConnector {
	...
	protected OpenKMResponse executeAction(OKMWebservices ws) {
		if (LOGGER.isLoggable(Level.INFO)) {
            LOGGER.info("Executing DeleteDocumentConnector with params: documentName:"+docId);
        }
		OpenKMResponse response = new OpenKMResponse();

		try {
				ws.deleteDocument(docId);
